...
- **117,6 В (28S) не подтверждено ничем.** Искал по «117.6V», по «116.8V», по зарядным
  ...
  > **Поправка 09.08.2026.** Чисел не три, а два: подпись «117,6 В» оказалась **нашей** — оригинал
  > называет 116 (`67V/84V/100V/116V/134V/168V`), что сходится с его же множителем. Подпись
  > исправлена на 116,8 В. Поиск выше от этого не обесценивается, а укрепляется: искали и по
  > «116.8V» тоже, и не нашли ничего. Расхождение множителя с числом ячеек — унаследованное, и оно
  > остаётся.
