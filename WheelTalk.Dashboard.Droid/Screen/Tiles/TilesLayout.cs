...
public static class TilesLayout
{
    ...
    /// <summary>
    /// Отступ подписи от края плитки — <b>свой, малый</b>, вместо общего поля (<see cref="PaddingDp"/>),
    /// и <b>один на все формы</b>: подпись прижата к верхнему левому углу, где бы она ни стояла
    /// (слова владельца 11.08.2026 — «сдвинуть вверх и влево», «все таблички единообразны»).
    /// <para>
    ...
    /// </para>
    /// <para>
    /// <b>Меряется он до видимой краски, а не до кегля</b> (<c>TileLabelStyle</c>): у глифов свои
    /// внутренние поля, и отступ, отмеренный от номинала, оставляет над буквой пустоту сверх
    /// заданной — сдвиг с 8 dp на 6 владелец оттого и не увидел.
    /// </para>
    /// </summary>
    ...
    /// установки.</b> Перенесена один в один: состав, порядок, размеры, виды, разделитель и все
    /// пер-плиточные настройки — пороги, свойства графиков, сторона крайних, подписи и полосы жара. Это не
    ...
    [
        ...
        // Разделитель ровно здесь: выше — то, что говорит о поездке прямо сейчас (графики и
        // крайние), ниже — состояние колеса. Владелец поставил его сам и принял 11.08.2026.
        MetricTile.Divider(),
