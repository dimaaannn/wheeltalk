    ...
    int? Decimals = null, string Caption = "")
{
    ...
    /// <summary>
    /// Начинать ли этой плиткой новую группу: над ней проводится черта во всю ширину (решение
    /// владельца 11.08.2026).
    /// <para>
    /// <b>Свойством плитки, а не отдельным видом-разделителем.</b> Вид занял бы целую строку сетки
    /// (68 dp) ради одной линии, а дробной высоты у сетки нет вовсе; черта же места не занимает —
    /// она рисуется по верхнему краю той плитки, с которой группа начинается.
    /// </para>
    /// </summary>
