    ...
    float ValueBleedPx = 0)
{
    ...
    /// <summary>
    /// До какого отношения сторон плитка считается квадратной. Замер сетки 10.08.2026 на 360 dp:
    /// четвертная 83,8×68 — 1,23; половина в две строки 170,5×142 — 1,20; ряд 170,5×68 — 2,51;
    /// полоса в три строки 344×216 — 1,59. Порог 1,45 отделяет первые две от последних двух с
    /// запасом в обе стороны и не зависит от плотности экрана: отношение безразмерно.
    /// </summary>
    public float SquareRatio { get; init; } = 1.45f;
