    ...
    float ValueBleedPx = 0)
{
    ...
    /// 170,5×62 — 2,75; полоса в три строки 343,8×198 — 1,74. Порог 1,45 по-прежнему отделяет первые
    /// две от последних двух, но запас сверху стал тесным: на экране в 411 dp четвертная выходит
    /// 1,56 и квадратом уже не считается. Ждёт слова владельца — 1,65 держал бы квадраты на обеих
    /// ширинах и полосы не трогал.
    /// </para>
    /// </summary>
