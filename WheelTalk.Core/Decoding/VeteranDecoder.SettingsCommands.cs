...
public sealed partial class VeteranDecoder : IVeteranSettingsCommands
{
    ...
    /// он зашит константой. Так сборщик убирает копипасту между одиннадцатью однотипными командами,
    ...
    private static byte[] BuildSettingWrite(byte opcode, int value)
    {
        ...
        // N = opcode − 12. Сходится со всеми одиннадцатью литералами производителя: 17→5, 18→6,
        // 20→8, 21→9, 23→11, 24→12, 26→14, 28→16, 29→17, 31→19, 33→21, 34→22.
