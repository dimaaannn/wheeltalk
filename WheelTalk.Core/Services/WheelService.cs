...
public sealed partial class WheelService : IDisposable
{
    ...
    /// Опрос InMotion V1 идёт каждые 25 мс, и в поле это мусор, который никто не прочтёт.
    /// </para>
    /// <para>
    ...
    /// придёт первый снимок, окно закрывается само. Опрос по таймеру (InMotion V1, каждые 25 мс) не
