...
public enum WheelProtocol
{
    ...
    /// рукопожатие; отличий два — телеметрия неопознанной модели не разбирается раскладкой V11, а
    /// опрос идёт по таймеру надстройки (шаг из настройки, 250…1000 мс) вместо ответозависимого
    /// тика порта, см. <see cref="Decoding.InMotionDecoderV2_1"/>.
    /// </summary>
    InMotionV2_1 = 5,
}
