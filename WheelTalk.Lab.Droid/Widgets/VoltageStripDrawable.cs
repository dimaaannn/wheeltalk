...
public sealed class VoltageStripDrawable
{
    ...
    /// варианта B полоса показывает «сколько осталось», и порог здесь абсолютный. Настройка рядом
    /// с ним называется похоже (<see cref="DashboardOptions.SagWarnVolts"/>), но говорит о другом —
    /// о просадке от холостого хода, — и брать её сюда значило бы вычитать одно из другого.
    /// </summary>
