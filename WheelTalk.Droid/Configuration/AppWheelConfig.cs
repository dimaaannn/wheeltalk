...
/// <summary>
/// POCO <see cref="IWheelConfig"/> bound from the "WheelConfig" section (defaults ship in
/// Resources/Raw/appsettings.json, per-wheel overrides come from the user settings file).
/// Property setters allow the "reported" writes decoders make at runtime (HwPwm, LightEnabled,
/// IsAlexovikFW), so DI must hand out one shared mutable instance, never a copy.
/// </summary>
public sealed class AppWheelConfig : IWheelConfig
{
    ...
    /// <summary>Шаг опроса InMotion V2 — заводские 250 мс дают круг 750 мс, темп DarknessBot.</summary>
